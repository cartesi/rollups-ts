...
import { create } from "@cartesi/machine";
...
// @noErrors
import { create } from "@cartesi/machine"; // [!code --] // [!code focus]
import { BreakReason, create } from "@cartesi/machine"; // [!code ++] // [!code focus]
...
The complete [CartesiMachine](/machine/CartesiMachine) API is available in the API section.
