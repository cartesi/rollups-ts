...
Accepts or rejects the previous request, yields the machine, and blocks until the next request arrives. This is the low-level request cycle primitive — [`run`](/rollup/run) calls it for you.
